...
<body>
    ...
    <h1>Halaman Edit Data Barang2</h1>
    <br>
    <form action="proses_tambah.php" method="post">
        <label for="">Id Barang</label>
        <input type="number" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="id_barang">
        <br>
        <label for="">Id jenis</label>
        <input type="number" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="id_jenis">
        <br>
